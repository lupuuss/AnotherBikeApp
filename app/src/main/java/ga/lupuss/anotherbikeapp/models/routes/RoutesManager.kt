...
class RoutesManager(val user: User,
    ...
    fun addOnShortRoutesDataChangedListener(onRoutesChangedListener: OnDocumentChanged) {

        onRoutesChangedListeners.add(onRoutesChangedListener)
    }

    fun removeOnShortRoutesDataChangedListener(onRoutesChangedListener: OnDocumentChanged) {
    ...
    fun shortRouteDataCount() = queryManager.size
