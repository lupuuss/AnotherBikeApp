 ...
 */
class StatisticsManagerImpl @Inject constructor(private val context: Context) : StatisticsManager {

    override val savedRoute = mutableListOf<LatLng>()
    override var lastStats: Map<Statistic.Name, Statistic>? = null
    ...
    override var minSpeedToCount = kmh5

    override var speedUnit = Statistic.Unit.KM_H
    override var distanceUnit = Statistic.Unit.KM
    ...
    override var onNewStats: ((stats: Map<Statistic.Name, Statistic>) -> Unit)? = null
    ...
    override fun pushNewLocation(location: Location) {
    ...
    override fun notifyLostLocation() {
